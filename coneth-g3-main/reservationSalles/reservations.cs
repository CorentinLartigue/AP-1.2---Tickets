...
namespace reservationSalles2018
{
    public partial class frmReservations : Form
    {
        ...
        public void reservationsSemaineSalle(DateTime uneDate, int uneSalle)
        {
            ...
            dateFinSemaine = uneDate.AddDays(5);
        ...
        private void reservations_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i <= 103; i++)
            {
                ...
                cbxSemaines.Items.Add(debutSemaine.ToShortDateString() + " - " + debutSemaine.AddDays(5).ToShortDateString());
        ...
        private void btnAjouterReservation_Click(object sender, EventArgs e)
        {
            ...
            if(cbxSallesReservation.SelectedIndex != -1 && cbxReservants.SelectedIndex != -1 && dgvSemaine.SelectedCells.Count == 1 && dgvSemaine.SelectedCells[0].Value == null)
            {
                ...
                if (dateReservation < DateTime.Today || dateReservation > DateTime.Today.AddDays(90))
                {
                    MessageBox.Show("Vous ne pouvez pas réserver à des dates antérieures ou postérieures");
                    SystemSounds.Beep.Play();
                }
                else
                {
